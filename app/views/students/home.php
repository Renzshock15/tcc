            ...
            <div class="row">
                ...
                <div class="col-xl-2 col-lg-3 col-md-12 sidebar fixed-top">
                    ...
                    <ul class="navbar-nav flex-column mt-4">
                        <li class="nav-item"><a href="<?php echo URLROOT; ?>/students/home" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-home text-light fa-lg mr-3"></i>Home</a></li>
            ...
            $('.btnPost').click(function() {
                ...
                if (title === '' || post === '') {
                    ...
                    $('.confirmPost').click(function() {
                        $.ajax({
                            url: '<?php echo URLROOT ?>' + '/Actions/AddPost1',
                            method: 'post',
                            data: {
                                title: title,
                                post: post
