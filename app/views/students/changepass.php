                        ...
                        <div class="ml-lg-auto mr-3 ml-3">
                            <div class="dropdowns">
                                ...
                                <div class="dropdown-menu dropdown-menu-right mr-xl-1 mt-1" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item small" href="<?php echo URLROOT; ?>/students/change_password">Change Password</a>
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="mt-5">
                        ...
                        <form action="<?php echo URLROOT; ?>/students/change_password" method="post">
                            <div class="form-group">
                                <label for="student-id"><strong>Student Id: <sup>*</sup></strong></label>
                                <input type="text" name="student-id" class="form-control form-control <?php echo (!empty($data['student_err'])) ? 'is-invalid' : ''; ?>">
