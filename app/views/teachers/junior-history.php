                                ...
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            ...
                                            <li class="breadcrumb-item"><a class="text-danger" href="<?php echo URLROOT; ?>/teachers/junior_history_list/<?php echo $data['subjectId'] . '/'  . $data['schoolYear']; ?>">Student List</a></li>
