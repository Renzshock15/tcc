            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="mt-5">
                        ...
                        <form action="<?php echo URLROOT; ?>/teachers/change_password" method="post">
                            <div class="form-group">
                                <label for="name"><strong>Employee Id: <sup>*</sup></strong></label>
                                <input type="text" name="employee-id" class="form-control form-control <?php echo (!empty($data['employee_err'])) ? 'is-invalid' : ''; ?>">
                                <span class="invalid-feedback"><?php echo $data['employee_err']; ?></span>
                            </div>
                            <div class="form-group">
