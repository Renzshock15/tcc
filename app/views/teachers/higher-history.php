                                ...
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            ...
                                            <li class="breadcrumb-item"><a class="text-danger" href="<?php echo URLROOT; ?>/teachers/higher_history_list/<?php echo $data['subjectId'] . '/'  . $data['sem'] . '/' . $data['schoolYear']; ?>">Student List</a></li>
