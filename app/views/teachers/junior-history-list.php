                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="row mx-auto">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 px-0">
                                            <div class="mt-4">
                                                <a class="btn btn-success float-lg-right" role="button" href="<?php echo URLROOT; ?>/teachers/junior_history/<?php echo $data['subjectId'] . '/' . $data['schoolYear']; ?>"><i class="fas fa-chart-bar"></i> View Summary</a>
                                            </div>
                                        </div>
                                    </div>
