                                        ...
                                        <table class="tablesgrade" id="jrTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>9</th>
                                                    <th>10</th>
                                                    <th class="dontShow">11</th>
                                                    <th class="dontShow">12</th>
                                                    <th class="dontShow">13</th>
                                                    <th class="dontShow">14</th>
                                                    <th class="dontShow">15</th>
                                                    <th>Total</th>
                                                    <th>PS</th>
                                                    <th>WS</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="jhs" data-row="1" data-column="1" data-id=" <?php echo 0; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act1Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act1Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act1; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td data-bs-toggle="tooltip" data-bs-placement="top" title="Behavior" class="jhs" data-row="1" data-column="2" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act2Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act2Name; ?><?php endforeach; ?>">
                                                        &nbsp;
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                    ...
                                                    <td class="jhs" data-row="1" data-column="3" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act3Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act3Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act3; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs" data-row="1" data-column="4" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act4Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act4Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act4; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs" data-row="1" data-column="5" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act5Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act5Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act5; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs" data-row="1" data-column="6" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act6Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act6Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act6; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs" data-row="1" data-column="7" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act7Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act7Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act7; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs" data-row="1" data-column="8" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act8Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act8Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act8; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs" data-row="1" data-column="9" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act9Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act9Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act9; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs" data-row="1" data-column="10" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act10Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act10Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act10; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs dontShow" data-row="1" data-column="11" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act11Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act11Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act11; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs dontShow" data-row="1" data-column="12" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act12Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act2Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act12; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs dontShow" data-row="1" data-column="13" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act13Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act13Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act13; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs dontShow" data-row="1" data-column="14" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act14Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act14Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act14; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs dontShow" data-row="1" data-column="15" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act15Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act15Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                    ...
                                                    <td class="jhsWs" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->actWs; ?><?php endforeach; ?>" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>">
                                                        <?php $ws = 0; ?>
                                                ...
                                                <div id="outputJr">
                                                    <?php foreach ($data['studentInfo'] as $studentInfos) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="dontShow" contenteditable="<?php echo (!empty($highJr->act11)) ? 'true' : 'false'; ?>" data-label="11">
                                                            ...
                                                            <td class="dontShow" contenteditable="<?php echo (!empty($highJr->act12)) ? 'true' : 'false'; ?>" data-label="12">
                                                            ...
                                                            <td class="dontShow" contenteditable="<?php echo (!empty($highJr->act13)) ? 'true' : 'false'; ?>" data-label="13">
                                                            ...
                                                            <td class="dontShow" contenteditable="<?php echo (!empty($highJr->act14)) ? 'true' : 'false'; ?>" data-label="14">
                                                            ...
                                                            <td class="dontShow" contenteditable="<?php echo (!empty($highJr->act15)) ? 'true' : 'false'; ?>" data-label="15">
                                                            ...
                                                            <td data-label="Action">
                                                                <span><button class="btn btn-info mr-1 btnsave" href="" data-id="<?php echo $studentInfos->g_j_id; ?>" role="button"><i class="far fa-save"></i></button><button class="btn btn-danger btndelete" href="" data-id="<?php echo $studentInfos->enrollee_id; ?>" role="button" <?php echo ($data['checkIfExsist'] === true) ? 'disabled' : ''; ?>><i class="far fa-trash-alt"></i></button></span>
                                                            </td>
                                                        </tr>
                                    ...
                                    <div class="row mx-auto">
                                        <div class="col-xl-6 col-lg-6 col-md-12 pl-0">
                                            <div class="btn-group btn-group-toggle mt-4" data-toggle="buttons">
                                                ...
                                                <label class="btn btn-primary radio_quarter rq3" data-radio="3rd quarter">
                                                    <input type="radio" name="options" id="option3" value="3rd" autocomplete="off">3rd
                                                </label>
                                                <label class="btn btn-primary radio_quarter rq4" data-radio="4th quarter">
                                                    <input type="radio" name="options" id="option4" value="4th" autocomplete="off">4th
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-12 px-0">
                                            <div class="mt-4">
                                                <a class="btn btn-success float-lg-right" role="button" href="<?php echo URLROOT; ?>/teachers/junior_summary/<?php echo $data['subjectId'] ?>"><i class="fas fa-chart-bar"></i> View Summary</a>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        if (getPresserveGradeSource !== null && getPresserveGradeQuarter !== null) {
            ...
            $.ajax({
                url: '<?php echo URLROOT ?>' + '/Actions/loadGradesJr',
                method: 'post',
                data: {
            ...
            if ($(this).data('value') === '') {
                ...
                $('#updateWs').click(function() {
                    ...
                    if (checkIfNumeric(newWs)) {
                        $.ajax({
                            url: '<?php echo URLROOT ?>' + '/Actions/updateJrWs',
                            method: 'post',
                            data: {
                                gradeSource: gradeSource,
                                gradeQuarter: gradeQuarter,
                    ...
                    if (actName === 'Choose...') {
                        ...
                        if ($('#actHighScore').val() === '' && $('#otherVal').val() === '') {
                            ...
                            if (checkIfNumeric(jrHs)) {
                                $.ajax({
                                    url: '<?php echo URLROOT ?>' + '/Actions/addJrHighGrade',
                                    method: 'post',
                                    data: {
                                        gradeSource: gradeSource,
                                        gradeQuarter: gradeQuarter,
    ...
    function addJrGrades(gradeSource, gradeQuarter) {
        $('#jrTable tbody').on('click', '.btnsave', function() {
            ...
            if (checkIfNumeric(activities)) {
                $.ajax({
                    url: '<?php echo URLROOT ?>' + '/Actions/updateJrGradeTable',
                    method: 'post',
                    data: {
                        gradeSource: gradeSource,
                        gradeQuarter: gradeQuarter,
    ...
    function removeJrStudents(gradeSource, gradeQuarter) {
        $('#jrTable tbody').on('click', '.btndelete', function() {
            var jrGradeId = $(this).data('id');
            var subjectIds = '<?php echo $data['subjectId'] ?>';

            $.ajax({
                url: '<?php echo URLROOT ?>' + '/Actions/removeJrStudent',
                method: 'post',
                data: {
                    gradeSource: gradeSource,
                    gradeQuarter: gradeQuarter,
