                                ...
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            ...
                                            <li class="breadcrumb-item "><a class="text-danger" href="<?php echo URLROOT; ?>/teachers/senior_grade2/senior/<?php echo $data['subjectId'] ?>">Student List</a></li>
                                                ...
                                                <div id="outputJr">
                                                    <?php foreach ($data['studentInfo'] as $studentInfos) : ?>
                                                        <tr>
                                                            ...
                                                            <!--1st quarter-->
                                                            <td data-label="3rd Initial Grade" class="first_ig">
                                                            ...
                                                            <td data-label="3rd Quarterly Grade" class="first_quarter">
                                                            ...
                                                            <!--2nd quarter-->
                                                            <td data-label="4th Initial Grade" class="second_ig">
                                                            ...
                                                            <td data-label="4th Quarterly Grade" class="second_quarter">
