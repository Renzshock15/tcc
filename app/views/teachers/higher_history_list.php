                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="row mx-auto">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 px-0">
                                            <div class="mt-4">
                                                <a class="btn btn-success float-lg-right" role="button" href="<?php echo URLROOT; ?>/teachers/higher_history/<?php echo $data['subjectId'] . '/' . $data['sem'] . '/' . $data['schoolYear']; ?>"><i class="fas fa-chart-bar"></i> View Summary</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php if (empty($data['studentInfo'])) : ?>
...
<script>
    $(document).ready(function() {
        ...
        $('.radio_gradeSource').click(function() {
            ...
            $.ajax({
                url: '<?php echo URLROOT ?>' + '/Actions/loadGradesCollegeAll',
                method: 'post',
                data: {
