...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT ?>/css/admin-login.css">
...
<body>
    ...
    <div class="container-fluid bg">
        ...
        <div class="row justify-content-center">
            <form class="form-container" method="post" id="loginForm" action="<?php echo URLROOT; ?>/users/cz_admin">
                ...
                <div class="form-logo mb-4 ">
                    ...
                    <h1 class="adName">Admin</h1>
                </div>
                <div class="form-group mt-2 border-bottom">
                    <div class="input-group-prepend">
                        <div class="input-group-text txticon"><i class="fa fa-user" aria-hidden="true"></i></div>
                        <input class="txt" type="text" class="form-control" id="student-no" name="txtstudent-no" aria-describedby="emailHelp" placeholder="User Id">
                    </div>
                </div>
