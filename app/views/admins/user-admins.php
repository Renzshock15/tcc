            ...
            <div class="row">
                ...
                <div class="col-xl-2 col-lg-3 col-md-12 sidebar fixed-top">
                    ...
                    <ul class="navbar-nav flex-column mt-4">
                        ...
                        <li class="nav-item"><a href="<?php echo URLROOT; ?>/admins/administrator" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-users text-light fa-lg mr-3"></i>Admins</a></li>
                ...
                <div class="col-12 mx-auto">
                    <div class="card pl-0 pr-0 mt-1">
                        ...
                        <div class="card-header bg-white">
                            <button class="btn btn-primary float-right addAdmin" href="" data-id="<?php echo $admins->id; ?>" role="button"><i class="fas fa-user-plus"></i> Admin</button>
        ...
        $('.addAdmin').click(function() {
            ...
            $('.saveAdmin').click(function() {
                ...
                if (fname === '' || lname === '' || userId === '' || role === 'Choose...') {
                    ...
                    $.ajax({
                        url: '<?php echo URLROOT ?>' + '/Actions/addNewAdmin',
                        method: 'post',
                        data: {
                            fname: fname,
                            lname: lname,
        ...
        $('.btnChangeRole').click(function() {
            ...
            if (adminRole === 'partial') {
                ...
                if (adminId == adminIds) {
                    ...
                    $.ajax({
                        url: '<?php echo URLROOT ?>' + '/Actions/changeAdminRole',
                        method: 'post',
                        data: {
                            adminId: adminId,
                            role: role,
        ...
        $('.btnChangeStat').click(function() {
            ...
            if (adminRole === 'partial') {
                ...
                if (adminId == adminIds) {
                    ...
                    $.ajax({
                        url: '<?php echo URLROOT ?>' + '/Actions/changeAdminStatus',
                        method: 'post',
                        data: {
                            adminId: adminId,
                            status: status,
            ...
            if (adminRole === 'partial') {
                ...
                if (adminId == adminIds) {
                    ...
                    $('.deleteYes').click(function() {
                        $.ajax({
                            url: '<?php echo URLROOT ?>' + '/Actions/deleteAdminUser',
                            method: 'post',
                            data: {
                                adminId: adminId,
