            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="mt-5">
                        ...
                        <p>Please complete all field to change user id</p>
                        <form action="<?php echo URLROOT; ?>/admins/change_userId" method="post">
                            <div class="form-group">
                                <label for="name"><strong>Old User Id: <sup>*</sup></strong></label>
                                <input type="text" name="user_id" class="form-control form-control <?php echo (!empty($data['old_user_err'])) ? 'is-invalid' : ''; ?>">
                                <span class="invalid-feedback"><?php echo $data['old_user_err']; ?></span>
                            </div>
                            <div class="form-group">
                                <label for="old_password"><strong>New User Id: <sup>*</sup></strong></label>
                                <input type="text" name="new_user_id" class="form-control form-control <?php echo (!empty($data['new_user_err'])) ? 'is-invalid' : ''; ?>">
                                <span class="invalid-feedback"><?php echo $data['new_user_err']; ?></span>
                            </div>
