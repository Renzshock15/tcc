            ...
            <div class="row">
                ...
                <div class="col-xl-2 col-lg-3 col-md-12 sidebar fixed-top">
                    ...
                    <ul class="navbar-nav flex-column mt-4">
                        ...
                        <li class="nav-item"><a href="<?php echo URLROOT; ?>/admins/instructors" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-users text-light fa-lg mr-3"></i>Instructors</a></li>
                    </ul>
                </div>
                <!-- end of sidebar -->
                <!-- top-nav -->
                ...
                <div class="col-12 mx-auto">
                    <div class="card pl-0 pr-0 mt-1">
                        ...
                        <div class="card-header bg-white">
                            <button class="btn btn-primary float-right addRegistrar" href="" data-id="" role="button"><i class="fas fa-user-plus"></i> Teacher</button>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <div id="outputJr">
                                    <?php if (!empty($data['teachers'])) : ?>
                                        <table class="tablesgrade" id="jrTable">
                                            ...
                                            <tbody>
                                                <div id="outputJr">
                                                    <?php foreach ($data['teachers'] as $admins) : ?>
                                                        <tr>
                                ...
                                <?php if (empty($data['teachers'])) : ?>
                                    <h5 class="ml-1 mt-3"><?php echo 'No available teacher'; ?></h5>
                                <?php endif; ?>
                            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary saveTeacher">Save Teacher</button>
            </div>
        </div>
    </div>
</div>
        ...
        $('.addRegistrar').click(function() {
            ...
            $('.saveTeacher').click(function() {
                ...
                if (fname === '' || lname === '' || userId === '' || department === 'Choose...') {
                    ...
                    $.ajax({
                        url: '<?php echo URLROOT ?>' + '/Actions/addNewTeacher',
                        method: 'post',
                        data: {
                            fname: fname,
                            lname: lname,
