                                ...
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            <li class="breadcrumb-item active ml-lg-auto" aria-current="page">Strand</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive mb-5">
                                <table class="tables">
                                    ...
                                    <tbody>
                                        <?php foreach ($data['higherCourses'] as $higherCourses) : ?>
                                            <tr>
                                                <td data-label="Code">
                                                    <a href="<?php echo URLROOT; ?>/registrars/student_subjects_course/<?php echo $higherCourses->id; ?>" class="text-body font-weight-bold"><?php echo $higherCourses->code; ?></a>
                                                </td>
                                                <td data-label="Subject">
                                                    <?php echo $higherCourses->description; ?>

                                                </td>
                                                <td data-label="Level">
                                                    <?php echo $higherCourses->cat_name; ?>

                                                </td>
                                                <td data-label="Action">
                                                    <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/student_subjects_course/<?php echo $higherCourses->id; ?>" role="button"><i class="fas fa-book-open text-light fa-lg mr-1"></i> View</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
