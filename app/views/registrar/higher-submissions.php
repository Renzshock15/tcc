                ...
                <div class="col-12 mx-auto">
                    ...
                    <div class="card pl-0 pr-0 mt-3">
                        <div class="card-body pb-0">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4>Higher Subjects</h4>
                                </div>
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">

                                            <li class="breadcrumb-item active ml-lg-auto" aria-current="page">Subject List</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div id="result">
                                <div class="table-responsive mb-5">
                                    <table class="tables">
                                        ...
                                        <tbody>
                                            <?php foreach ($data['higherSubjects'] as $higherSubjects) : ?>
                                                <tr>
                                                    <td data-label="Subject">
                                                        <a href="<?php echo URLROOT; ?>/registrars/higher_submission_list/<?php echo $higherSubjects->sched_id . '/' . $higherSubjects->semester . '/' . $higherSubjects->school_year; ?>" class="text-body font-weight-bold"><?php echo $higherSubjects->subject_name; ?></a>
                                                    </td>
                                                    <td data-label="Level">
                                                        <?php echo $higherSubjects->year_level; ?>

                                                    </td>
                                                    <td data-label="Sem">
                                                        <?php if ($higherSubjects->semester == 1) {
                                                            echo 'First';
                                                    ...
                                                    <td data-label="School Year">
                                                        <?php echo $higherSubjects->school_year; ?>

                                                    </td>
                                                    <td data-label="Instructor">
                                                        <?php echo $higherSubjects->lname . ', ' . $higherSubjects->fname; ?>

                                                    </td>
                                                    <td data-label="View Student">
                                                        <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/higher_submission_list/<?php echo $higherSubjects->sched_id . '/' . $higherSubjects->semester . '/' . $higherSubjects->school_year; ?>" role="button"><i class="fas fa-share-square text-light fa-lg mr-1"></i> View</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
...
<script>
    $(document).ready(function() {
        $('.txtSearch').keyup(function() {
            ...
            if (searchField != '') {
                $.ajax({
                    url: '<?php echo URLROOT ?>' + '/Actions/higherSubjectFinalList',
                    method: 'post',
                    data: {
