                            ...
                            <div class="table-responsive mb-5">
                                <table class="tables">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td data-label="Level">
                                                <a href="<?php echo URLROOT; ?>/registrars/junior_offline_list" class="text-body font-weight-bold"><?php echo 'Junior High School'; ?></a>
                                            </td>
                                            ...
                                            <td data-label="View Student">
                                                <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/junior_offline_list" role="button"><i class="fas fa-users text-light fa-lg mr-1"></i> View</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td data-label="Level">
                                                <a href="<?php echo URLROOT; ?>/registrars/senior_offline_list" class="text-body font-weight-bold"><?php echo 'Senior High School'; ?></a>
                                            </td>
                                            <td data-label="Description">
                                            ...
                                            <td data-label="View Student">
                                                <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/senior_offline_list" role="button"><i class="fas fa-users text-light fa-lg mr-1"></i> View</a>
                                            </td>
                                        </tr>
