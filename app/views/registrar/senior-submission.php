                ...
                <div class="col-12 mx-auto">
                    ...
                    <div class="card pl-0 pr-0 mt-3">
                        <div class="card-body pb-0">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4>Senior Subjects</h4>
                                </div>
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            <li class="breadcrumb-item ml-lg-auto"> <a class="text-danger" href="<?php echo URLROOT; ?>/registrars/grade_submissions">Levels</a></li>
                ...
                <div class="col-12 mx-auto">
                    <div class="card pl-0 pr-0 mt-1">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-8">
                                    <form class="form-inline" method="POST" action="<?php echo URLROOT; ?>/registrars/senior_submission">
                                        <div class="form-group  mb-2">
                                            <label for="inputPassword2" class="sr-only">Password</label>
                                            <input type="text" class="form-control txtSearch" id="inputPassword2" placeholder="Search" name="txtSearch">
                                        </div>
                                        <button type="submit" class="btn btn-primary mb-2 ml-2 btnSearch" name="btnSearch">Search</button>
                            ...
                            <div class="table-responsive mb-5">
                                <table class="tables">
                                    ...
                                    <tbody>
                                        <?php foreach ($data['seniorSubjects'] as $juniorSubjects) : ?>
                                            <tr>
                                                <td data-label="Subject">
                                                    <a href="<?php echo URLROOT; ?>/registrars/senior_submission_list/<?php echo $juniorSubjects->subject_id . '/' . $juniorSubjects->subject_term . '/' . $juniorSubjects->school_year; ?>" class="text-body font-weight-bold"><?php echo $juniorSubjects->subject_name; ?></a>
                                                </td>
                                                <td data-label="Level">
                                                    <?php echo $juniorSubjects->year_level; ?>

                                                </td>
                                                <td data-label="Sem">
                                                    <?php if ($juniorSubjects->subject_term == 1) {
                                                        echo 'First';
                                                    } elseif ($juniorSubjects->subject_term == 2) {
                                                        echo 'Second';
                                                    } ?>

                                                </td>
                                                <td data-label="School Year">
                                                    <?php echo $juniorSubjects->school_year; ?>

                                                </td>
                                                <td data-label="Teacher">
                                                    <?php echo $juniorSubjects->last_name . ', ' . $juniorSubjects->first_name; ?>

                                                </td>
                                                <td data-label="View Student">
                                                    <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/senior_submission_list/<?php echo $juniorSubjects->subject_id . '/' . $juniorSubjects->subject_term . '/' . $juniorSubjects->school_year; ?>" role="button"><i class="fas fa-share-square text-light fa-lg mr-1"></i> View</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
