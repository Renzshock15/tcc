                            ...
                            <div class="table-responsive mb-5">
                                <table class="tables">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td data-label="Level">
                                                <a href="<?php echo URLROOT; ?>/registrars/junior_submission" class="text-body font-weight-bold"><?php echo 'Junior High School'; ?></a>
                                            </td>
                                            <td data-label="Description">
                                                <?php echo 'Kinder - Grade 10'; ?>

                                            </td>
                                            <td data-label="View Student">
                                                <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/junior_submission" role="button"><i class="fas fa-share-square text-light fa-lg mr-1"></i> View</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td data-label="Level">
                                                <a href="<?php echo URLROOT; ?>/registrars/senior_submission" class="text-body font-weight-bold"><?php echo 'Senior High School'; ?></a>
                                            </td>
                                            <td data-label="Description">
                                                <?php echo 'Grade 11 - Grade 12'; ?>

                                            </td>
                                            <td data-label="View Student">
                                                <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/senior_submission" role="button"><i class="fas fa-share-square text-light fa-lg mr-1"></i> View</a>
                                            </td>
                                        </tr>
