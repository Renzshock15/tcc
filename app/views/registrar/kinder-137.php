                                ...
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            ...
                                            <li class="breadcrumb-item "> <a class="text-danger" href="<?php echo URLROOT; ?>/registrars/junior_list1">Student List</a></li>
                        ...
                        <div class="printable" id="printable">
                            ...
                            <div class="row mx-1 mt-5">
                                ...
                                <div class="col-lg-6 printWidth">
                                    ...
                                    <div class="mt-2">
                                        <h5><strong>Kinder 1 - Shool:</strong> <?php echo $data['school1']; ?></h5>
                                    </div>
                                    ...
                                    <div class="table-responsive mb-5">
                                        <table class="tablesgrade">
                                            ...
                                            <tbody>
                                                <?php if (!empty($data['kinder1'])) : ?>
                                                    <?php $kinderCount1 = 0;
                                                    $kinder1Avg = 0; ?>
                                                    <?php foreach ($data['kinder1'] as $subjectList) : ?>
                                                        <tr>
                                                        ...
                                                        <?php $kinderCount1 = $kinderCount1 + 1;
                                                        $kinder1Avg = $kinder1Avg + $subjectList->final_grade; ?>
                                                    <?php endforeach; ?>
                                                    <tr>
                                                        <td colspan="5">
                                                        ...
                                                        <td>
                                                            <h7><strong><?php echo  round($kinder1Avg / $kinderCount1, 2); ?></strong></h7>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                        ...
                                        <?php if (!empty($data['kinder_1'])) : ?>
                                            <div class="mt-3">
                                                <h5>Eligebility for admission to Kinder 2</h5>
                                            </div>
                                            <div class="mt-3">
                                ...
                                <div class="col-lg-6 printWidth">
                                    ...
                                    <div class="mt-2">
                                        <h5><strong>Kinder 2 - Shool:</strong> <?php echo $data['school2']; ?></h5>
                                    </div>
                                    <div class="table-responsive mb-5">
                                        <table class="tablesgrade">
                                            <thead>
                                            ...
                                            <tbody>
                                                <?php if (!empty($data['kinder2'])) : ?>
                                                    <?php $kinderCount2 = 0;
                                                    $kinder2Avg = 0; ?>
                                                    <?php foreach ($data['kinder2'] as $subjectList) : ?>
                                                        <tr>
                                                            <td data-label="Learning Area">
                                                                <?php echo  $subjectList->subject_name; ?>
                                                            </td>
                                                        ...
                                                        <?php $kinderCount2 = $kinderCount2 + 1;
                                                        $kinder2Avg = $kinder2Avg + $subjectList->final_grade; ?>
                                                    <?php endforeach; ?>
                                                    <tr>
                                                        <td colspan="5">
                                                            <h7><strong>General Average</strong></h7>
                                                        ...
                                                        <td>
                                                            <h7><strong><?php echo  round($kinder2Avg / $kinderCount2, 2); ?></strong></h7>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                        ...
                                        <?php if (!empty($data['kinder_2'])) : ?>
                                            <div class="mt-3">
                                                <h5>Eligebility for admission to Grade 1</h5>
                                            </div>
                                            <div class="mt-3">
                                                <h5>Signature of Adviser: ______________</h5>
                                            </div>
