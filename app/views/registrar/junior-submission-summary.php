                                ...
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            ...
                                            <li class="breadcrumb-item"><a class="text-danger" href="<?php echo URLROOT; ?>/registrars/junior_submission_list/<?php echo $data['subjectId'] . '/' . $data['schoolYears']; ?>">Student List</a></li>
                    ...
                    <div class="card pl-0 pr-0 mt-1">
                        <?php if (!empty($data['studentInfo'])) : ?>
                            <div class="card-header bg-white">
                                ...
                                <h5> <?php echo 'SY: ' . $data['schoolYear']; ?></h5>
                                <h5> <?php echo 'Grade - ' . $data['gradeLevel']; ?></h5>
                                                ...
                                                <div id="outputJr">
                                                    <?php foreach ($data['studentInfo'] as $studentInfos) : ?>
                                                        <tr>
                                                            ...
                                                            <td data-label="Initial">
                                                                <?php echo $studentInfos->tig; ?>
                                                            </td>
                                                            <td data-label="3rd Quarter">
                                                                <?php echo $studentInfos->tqg; ?>
                                                            </td>
                                                            <td>

                                                            </td>
                                                            <td data-label="Initial">
                                                                <?php echo $studentInfos->foig; ?>
                                                            </td>
                                                            <td data-label="4th Quarter">
                                                                <?php echo $studentInfos->foqg; ?>
                                                            </td>
                                                            <td>
