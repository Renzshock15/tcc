                ...
                <div class="col-12 mx-auto">
                    <div class="card pl-0 pr-0 mt-1">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-8">
                                    <form class="form-inline" method="POST" action="<?php echo URLROOT; ?>/registrars/senior_offline_list">
                                                ...
                                                <?php foreach ($data['seniorStudentList'] as $studentList) : ?>
                                                    <tr>
                                                        <td data-label="Full Name">
                                                            <a href="<?php echo URLROOT; ?>/registrars/senior_register_offline/<?php echo $studentList->infoId; ?>" class="text-body font-weight-bold"><?php echo $studentList->lname . ', ' . $studentList->fname . ' ' . $studentList->mname; ?></a>
                                                        </td>
                                                        ...
                                                        <td data-label="View Records">
                                                            <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/senior_register_offline/<?php echo $studentList->infoId; ?>" role="button"><i class="far fa-folder-open text-light fa-lg mr-1"></i> View</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
