                                ...
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            ...
                                            <li class="breadcrumb-item "> <a class="text-danger" href="<?php echo URLROOT; ?>/registrars/junior_list2">Student List</a></li>
                        ...
                        <div class="printable" id="printable">
                            ...
                            <div class="row mx-1 mt-5">
                                ...
                                <div class="col-lg-6 printWidth">
                                    <div>
                                        <h5><strong>School Year:</strong> <?php echo $data['schoolYear1']; ?></h5>
                                    </div>
                                    <div class="mt-2">
                                        <h5><strong>Grade 1 - Shool:</strong> <?php echo $data['school1']; ?></h5>
                                    </div>
                                    ...
                                    <div class="table-responsive mb-5">
                                        <table class="tablesgrade">
                                            ...
                                            <tbody>
                                                <?php if (!empty($data['grade1'])) : ?>
                                                    <?php $grade1Count = 0;
                                                    $grade1Avg = 0; ?>
                                                    <?php foreach ($data['grade1'] as $subjectList) : ?>
                                                        <tr>
                                                        ...
                                                        <?php $grade1Count = $grade1Count + 1;
                                                        $grade1Avg = $grade1Avg + $subjectList->final_grade; ?>
                                                    <?php endforeach; ?>
                                                    <tr>
                                                        <td colspan="5">
                                                        ...
                                                        <td>
                                                            <h7><strong><?php echo  round($grade1Avg / $grade1Count, 2); ?></strong></h7>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                        ...
                                        <?php if (!empty($data['grade1'])) : ?>
                                            <div class="mt-3">
                                                <h5>Eligebility for admission to Grade 2</h5>
                                            </div>
                                            <div class="mt-3">
                                ...
                                <div class="col-lg-6 printWidth">
                                    <div>
                                        <h5><strong>School Year:</strong> <?php echo $data['schoolYear2']; ?></h5>
                                    </div>
                                    <div class="mt-2">
                                        <h5><strong>Grade 2 - Shool:</strong> <?php echo $data['school2']; ?></h5>
                                    </div>
                                    <div class="table-responsive mb-5">
                                        <table class="tablesgrade">
                                            <thead>
                                            ...
                                            <tbody>
                                                <?php if (!empty($data['grade2'])) : ?>
                                                    <?php $grade2Count = 0;
                                                    $grade2Avg = 0; ?>
                                                    <?php foreach ($data['grade2'] as $subjectList) : ?>
                                                        <tr>
                                                            <td data-label="Learning Area">
                                                                <?php echo  $subjectList->subject_name; ?>
                                                            </td>
                                                        ...
                                                        <?php $grade2Count = $grade2Count + 1;
                                                        $grade2Avg = $grade2Avg + $subjectList->final_grade; ?>
                                                    <?php endforeach; ?>
                                                    <tr>
                                                        <td colspan="5">
                                                            <h7><strong>General Average</strong></h7>
                                                        ...
                                                        <td>
                                                            <h7><strong><?php echo  round($grade2Avg / $grade2Count, 2); ?></strong></h7>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                        ...
                                        <?php if (!empty($data['grade2'])) : ?>
                                            <div class="mt-3">
                                                <h5>Eligebility for admission to Grade 3</h5>
                                            </div>
                                            <div class="mt-3">
                                                <h5>Signature of Adviser: ______________</h5>
                                            </div>
                            ...
                            <div class="row mx-1 mt-5">
                                ...
                                <div class="col-lg-6 printWidth">
                                    <div>
                                        <h5><strong>School Year:</strong> <?php echo $data['schoolYear3']; ?></h5>
                                    </div>
                                    <div class="mt-2">
                                        <h5><strong>Grade 3 - Shool:</strong> <?php echo $data['school3']; ?></h5>
                                    </div>
                                    ...
                                    <div class="table-responsive mb-5">
                                        <table class="tablesgrade">
                                            ...
                                            <tbody>
                                                <?php if (!empty($data['grade3'])) : ?>
                                                    <?php $grade3Count = 0;
                                                    $grade3Avg = 0; ?>
                                                    <?php foreach ($data['grade3'] as $subjectList) : ?>
                                                        <tr>
                                                            <td data-label="Learning Area">
                                                                <?php echo  $subjectList->subject_name; ?>
                                                            </td>
                                                        ...
                                                        <?php $grade3Count = $grade3Count + 1;
                                                        $grade3Avg = $grade3Avg + $subjectList->final_grade; ?>
                                                    <?php endforeach; ?>
                                                    <tr>
                                                        <td colspan="5">
                                                            <h7><strong>General Average</strong></h7>
                                                        ...
                                                        <td>
                                                            <h7><strong><?php echo  round($grade3Avg / $grade3Count, 2); ?></strong></h7>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                        ...
                                        <?php if (!empty($data['grade3'])) : ?>
                                            <div class="mt-3">
                                                <h5>Eligebility for admission to Grade 4</h5>
                                            </div>
                                            <div class="mt-3">
                                                <h5>Signature of Adviser: ______________</h5>
                                            </div>
                                ...
                                <div class="col-lg-6 printWidth">
                                    <div>
                                        <h5><strong>School Year:</strong> <?php echo $data['schoolYear4']; ?></h5>
                                    </div>
                                    <div class="mt-2">
                                        <h5><strong>Grade 4 - Shool:</strong> <?php echo $data['school4']; ?></h5>
                                    </div>
                                    <div class="table-responsive mb-5">
                                        <table class="tablesgrade">
                                            <thead>
                                            ...
                                            <tbody>
                                                <?php if (!empty($data['grade4'])) : ?>
                                                    <?php $grade4Count = 0;
                                                    $grade4Avg = 0; ?>
                                                    <?php foreach ($data['grade4'] as $subjectList) : ?>
                                                        <tr>
                                                            <td data-label="Learning Area">
                                                                <?php echo  $subjectList->subject_name; ?>
                                                            </td>
                                                        ...
                                                        <?php $grade4Count = $grade4Count + 1;
                                                        $grade4Avg = $grade4Avg + $subjectList->final_grade; ?>
                                                    <?php endforeach; ?>
                                                    <tr>
                                                        <td colspan="5">
                                                            <h7><strong>General Average</strong></h7>
                                                        ...
                                                        <td>
                                                            <h7><strong><?php echo  round($grade4Avg / $grade4Count, 2); ?></strong></h7>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                        ...
                                        <?php if (!empty($data['grade4'])) : ?>
                                            <div class="mt-3">
                                                <h5>Eligebility for admission to Grade 5</h5>
                                            </div>
                                            <div class="mt-3">
                                                <h5>Signature of Adviser: ______________</h5>
                                            </div>
                            ...
                            <div class="d-none d-print-block">
                                <div class="row mt-5 justify-content-center pageBreak">
                                    <img src="<?php echo URLROOT; ?>/images/tcclogo.png" width="80px" height="80px" alt="">
                                    <div class="pl-2 pr-2">
                                        <h5 class="mt-4">TOMAS CALUDIO COLLEGES</h5>
                                        <h7 class="ml-4">Taghangin Morong, Rizal</h7>
                            ...
                            <div class="row mx-1 mt-5">
                                ...
                                <div class="col-lg-6 printWidth">
                                    <div>
                                        <h5><strong>School Year:</strong> <?php echo $data['schoolYear5']; ?></h5>
                                    </div>
                                    <div class="mt-2">
                                        <h5><strong>Grade 5 - Shool:</strong> <?php echo $data['school5']; ?></h5>
                                    </div>
                                    ...
                                    <div class="table-responsive mb-5">
                                        <table class="tablesgrade">
                                            ...
                                            <tbody>
                                                <?php if (!empty($data['grade5'])) : ?>
                                                    <?php $grade5Count = 0;
                                                    $grade5Avg = 0; ?>
                                                    <?php foreach ($data['grade5'] as $subjectList) : ?>
                                                        <tr>
                                                            <td data-label="Learning Area">
                                                                <?php echo  $subjectList->subject_name; ?>
                                                            </td>
                                                        ...
                                                        <?php $grade5Count = $grade5Count + 1;
                                                        $grade5Avg = $grade5Avg + $subjectList->final_grade; ?>
                                                    <?php endforeach; ?>
                                                    <tr>
                                                        <td colspan="5">
                                                            <h7><strong>General Average</strong></h7>
                                                        ...
                                                        <td>
                                                            <h7><strong><?php echo  round($grade5Avg / $grade5Count, 2); ?></strong></h7>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                        ...
                                        <?php if (!empty($data['grade5'])) : ?>
                                            <div class="mt-3">
                                                <h5>Eligebility for admission to Grade 6</h5>
                                            </div>
                                            <div class="mt-3">
                                                <h5>Signature of Adviser: ______________</h5>
                                            </div>
                                ...
                                <div class="col-lg-6 printWidth">
                                    <div>
                                        <h5><strong>School Year:</strong> <?php echo $data['schoolYear6']; ?></h5>
                                    </div>
                                    <div class="mt-2">
                                        <h5><strong>Grade 6 - Shool:</strong> <?php echo $data['school6']; ?></h5>
                                    </div>
                                    <div class="table-responsive mb-5">
                                        <table class="tablesgrade">
                                            <thead>
                                            ...
                                            <tbody>
                                                <?php if (!empty($data['grade6'])) : ?>
                                                    <?php $grade6Count = 0;
                                                    $grade6Avg = 0; ?>
                                                    <?php foreach ($data['grade6'] as $subjectList) : ?>
                                                        <tr>
                                                            <td data-label="Learning Area">
                                                                <?php echo  $subjectList->subject_name; ?>
                                                            </td>
                                                        ...
                                                        <?php $grade6Count = $grade6Count + 1;
                                                        $grade6Avg = $grade6Avg + $subjectList->final_grade; ?>
                                                    <?php endforeach; ?>
                                                    <tr>
                                                        <td colspan="5">
                                                            <h7><strong>General Average</strong></h7>
                                                        ...
                                                        <td>
                                                            <h7><strong><?php echo  round($grade6Avg / $grade6Count, 2); ?></strong></h7>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                                        ...
                                        <?php if (!empty($data['grade6'])) : ?>
                                            <div class="mt-3">
                                                <h5>Eligebility for admission to Grade 7</h5>
                                            </div>
                                            <div class="mt-3">
                                                <h5>Signature of Adviser: ______________</h5>
                                            </div>
