                                                ...
                                                <?php foreach ($data['higherStudents'] as $studentList) : ?>
                                                    <tr>
                                                        <td data-label="Full Name">
                                                            <a href="<?php echo URLROOT; ?>/registrars/higher_transcript/<?php echo $studentList->infoId; ?>" class="text-body font-weight-bold"><?php echo $studentList->lname . ', ' . $studentList->fname . ' ' . $studentList->mname; ?></a>
                                                        </td>
                                                        ...
                                                        <td data-label="View Records">
                                                            <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/higher_transcript/<?php echo $studentList->infoId; ?>" role="button"><i class="far fa-folder-open text-light fa-lg mr-1"></i> View</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
...
<script>
    $(document).ready(function() {
        $('.txtSearch').keyup(function() {
            ...
            if (searchField != '') {
                $.ajax({
                    url: '<?php echo URLROOT ?>' + '/Actions/higherStudentList',
                    method: 'post',
                    data: {
