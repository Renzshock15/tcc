                                ...
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            <li class="breadcrumb-item ml-lg-auto"> <a class="text-danger" href="<?php echo URLROOT; ?>/registrars/student_offline">Level</a></li>
                                            <li class="breadcrumb-item "> <a class="text-danger" href="<?php echo URLROOT; ?>/registrars/senior_offline_list">Student List</a></li>
...
<script>
    $(document).ready(function() {
        ...
        $('.txtSearch').keyup(function() {
            ...
            if (searchField != '') {
                $.ajax({
                    url: '<?php echo URLROOT ?>' + '/Actions/enrollSearchResult',
                    method: 'post',
                    data: {
    ...
    function addSubject(studentId) {
        $('.addSched').click(function() {
            ...
            $('.saveRec').click(function() {
                $.ajax({
                    url: '<?php echo URLROOT ?>' + '/Actions/enrollSenior',
                    method: 'post',
                    data: {
                        schedId: schedId,
                        semId: semId,
