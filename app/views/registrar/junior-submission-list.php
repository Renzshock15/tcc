                                ...
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            ...
                                            <li class="breadcrumb-item"><a class="text-danger" href="<?php echo URLROOT; ?>/registrars/junior_submission">Subject List</a></li>
                                ...
                                <div class="table-responsive">
                                        ...
                                        <table class="tablesgrade" id="jrTable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="jhs" data-row="1" data-column="2" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act2Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act2Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                    ...
                                                    <td class="jhs" data-row="1" data-column="11" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act11Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act11Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act11; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs" data-row="1" data-column="12" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act12Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act2Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act12; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs" data-row="1" data-column="13" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act13Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act13Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act13; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs" data-row="1" data-column="14" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act14Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act14Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                                            <strong><?php echo $highJr->act14; ?></strong>
                                                        <?php endforeach; ?>
                                                    </td>
                                                    <td class="jhs" data-row="1" data-column="15" data-id=" <?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->g_j_h_ids_id; ?><?php endforeach; ?>" data-value="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act15Id; ?><?php endforeach; ?>" data-name="<?php foreach ($data['jrHighScore'] as $highJr) : ?><?php echo $highJr->act15Name; ?><?php endforeach; ?>">
                                                        <?php foreach ($data['jrHighScore'] as $highJr) : ?>
                                    ...
                                    <div class="row mx-auto">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-12 px-0">
                                            <div class="mt-4">
                                                <a class="btn btn-success float-lg-right" role="button" href="<?php echo URLROOT; ?>/registrars/junior_submission_summary/<?php echo $data['subjectId'] . '/' . $data['schoolYear']; ?>"><i class="fas fa-chart-bar"></i> View Summary</a>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.radio_gradeSource').click(function() {
            ...
            $.ajax({
                url: '<?php echo URLROOT ?>' + '/Actions/loadGradesJrAll',
                method: 'post',
                data: {
