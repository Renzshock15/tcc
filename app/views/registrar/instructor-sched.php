            ...
            <div class="row">
                ...
                <div class="col-xl-2 col-lg-3 col-md-12 sidebar fixed-top">
                    ...
                    <ul class="navbar-nav flex-column mt-4">
                        ...
                        ?>
                        <li class="nav-item"><a href="<?php echo URLROOT; ?>/registrars/instructor_sched" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-users text-light fa-lg mr-3"></i>Schedule</a></li>
                                ...
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            ...
                                            <li class="breadcrumb-item active ml-lg-auto" aria-current="page">Schedule</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                ...
                <div class="col-12 mx-auto">
                    <div class="card pl-0 pr-0 mt-1">
                        <div class="card-body">
                            ...
                            <?php if (!empty($data['subjectSchedule'])) : ?>
                                <div id="result">
                                    <div class="table-responsive mb-5">
                                        <table class="tablesgrade">
                                            ...
                                            <tbody>
                                                <?php foreach ($data['subjectSchedule'] as $subjectSchedule) : ?>
                                                    <tr>
                                                        <td data-label="Code">
                                                            <?php echo $subjectSchedule->subjectCode; ?>
                                                        </td>
                                                        <td data-label="Description">
                                                            <?php echo $subjectSchedule->subjectDes; ?>
                                                        </td>
                                                        <td data-label="Section">
                                                            <?php echo $subjectSchedule->courseCode . ' - ' . $subjectSchedule->year_level . ' - ' . $subjectSchedule->sec_code; ?>

                                                        </td>
                                                        <td data-label="Sched1">
                                                            <?php echo $subjectSchedule->day . ' / ' . $subjectSchedule->start . ' - ' . $subjectSchedule->end; ?>

                                                        </td>
                                                        <td data-label="Sched2">
                                                            <?php if (empty($subjectSchedule->day2)) {
                                                                echo 'None';
                                                            } else {
                                                                echo $subjectSchedule->day2 . ' / ' . $subjectSchedule->start2 . ' - ' . $subjectSchedule->end2;
                                                            } ?>

                                                        </td>
                                                        <td data-label="Teacher">
                                                            <?php echo $subjectSchedule->first_name . '  ' . $subjectSchedule->last_name; ?>

                                                        </td>
                                                        <td data-label="Assign">
                                                            <button class="btn btn-info addIns" href="" data-id="<?php echo $subjectSchedule->ssId; ?>" role="button"><i class="far fa-user"></i></button>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                            ...
                            <?php endif; ?>
                            <?php if (empty($data['subjectSchedule'])) : ?>
                                <h5 class="ml-1 mt-3 mb-3"><?php echo 'No schedule available'; ?></h5>
                            <?php endif; ?>
...
<!--end of content-->
<div class="modal" tabindex="-1" id="addTeacher">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <select id="departments" class="form-control subjectSelect">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary addTeacher">Add</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        $('.txtSearch').keyup(function() {
            ...
            if (searchField != '') {
                $.ajax({
                    url: '<?php echo URLROOT ?>' + '/Actions/sortSchedule',
                    method: 'post',
                    data: {
    ...
    function addIns() {
        $('.addIns').click(function() {
            ...
            $('#departments').change(function() {
                ...
                $.ajax({
                    url: '<?php echo URLROOT ?>' + '/Actions/getTeachersByDep',
                    method: 'post',
                    data: {
                        depId: depId
                    },
            ...
            $('.addTeacher').click(function() {
                ...
                if (insId === 'Choose...') {
                    ...
                    $('.saveTeacher').click(function() {
                        $.ajax({
                            url: '<?php echo URLROOT ?>' + '/Actions/addTeacherTosched',
                            method: 'post',
                            data: {
                                insId: insId,
                                schedId: schedId
