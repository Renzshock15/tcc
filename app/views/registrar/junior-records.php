                                ...
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            <li class="breadcrumb-item active ml-lg-auto" aria-current="page">Levels</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tableHeader">
                                <div class="tableHeaderContent">
                                    <strong>Junior High Level</strong>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-lg-8">
                            ...
                            <div class="table-responsive mb-5">
                                <table class="tables">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td data-label="Level">
                                                <a href="<?php echo URLROOT; ?>/registrars/junior_list1" class="text-body font-weight-bold"><?php echo 'Kinder'; ?></a>
                                            </td>
                                            <td data-label="Description">
                                                <?php echo 'Kinder 1 - Kinder 2'; ?>

                                            </td>
                                            <td data-label="View Student">
                                                <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/junior_list1" role="button"><i class="fas fa-users text-light fa-lg mr-1"></i> View</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td data-label="Level">
                                                <a href="<?php echo URLROOT; ?>/registrars/junior_list2" class="text-body font-weight-bold"><?php echo 'Elementary'; ?></a>
                                            </td>
                                            <td data-label="Description">
                                                <?php echo 'Grade 1 - Grade 6'; ?>

                                            </td>
                                            <td data-label="View Student">
                                                <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/junior_list2" role="button"><i class="fas fa-users text-light fa-lg mr-1"></i> View</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td data-label="Level">
                                                <a href="<?php echo URLROOT; ?>/registrars/junior_list3" class="text-body font-weight-bold"><?php echo 'High School'; ?></a>
                                            </td>
                                            <td data-label="Description">
                                                <?php echo 'Grade 7 - Grade 10'; ?>

                                            </td>
                                            <td data-label="View Student">
                                                <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/junior_list3" role="button"><i class="fas fa-users text-light fa-lg mr-1"></i> View</a>
                                            </td>
                                        </tr>
