                ...
                <div class="col-12 mx-auto">
                    <div class="card pl-0 pr-0 mt-1">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-8">
                                    <form class="form-inline" method="POST" action="<?php echo URLROOT; ?>/registrars/junior_submission">
                            ...
                            <div class="table-responsive mb-5">
                                <table class="tables">
                                    ...
                                    <tbody>
                                        <?php foreach ($data['juniorSubjects'] as $juniorSubjects) : ?>
                                            <tr>
                                                <td data-label="Subject">
                                                    <a href="<?php echo URLROOT; ?>/registrars/junior_submission_list/<?php echo $juniorSubjects->subject_id . '/' . $juniorSubjects->school_year; ?>" class="text-body font-weight-bold"><?php echo $juniorSubjects->subject_name; ?></a>
                                                </td>
                                                <td data-label="Level">
                                                    <?php echo $juniorSubjects->grade_level; ?>
                                                ...
                                                <td data-label="View Student">
                                                    <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/junior_submission_list/<?php echo $juniorSubjects->subject_id . '/' . $juniorSubjects->school_year; ?>" role="button"><i class="fas fa-share-square text-light fa-lg mr-1"></i> View</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
