                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive mb-5">
                                <table class="tables">
                                    ...
                                    <tbody>
                                        <?php foreach ($data['seniorStrand'] as $seniorStrand) : ?>
                                            <tr>
                                                <td data-label="Code">
                                                    <a href="<?php echo URLROOT; ?>/registrars/student_subjects_strand/<?php echo $seniorStrand->id; ?>" class="text-body font-weight-bold"><?php echo $seniorStrand->code; ?></a>
                                                </td>
                                                <td data-label="Subject">
                                                    <?php echo $seniorStrand->description; ?>

                                                </td>
                                                <td data-label="Subjects">
                                                    <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/student_subjects_strand/<?php echo $seniorStrand->id; ?>" role="button"><i class="fas fa-book-open text-light fa-lg mr-1"></i> View</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
