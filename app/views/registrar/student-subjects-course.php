                ...
                <div class="col-xl-2 col-lg-3 col-md-12 sidebar fixed-top">
                    ...
                    <ul class="navbar-nav flex-column mt-4">
                        ...
                        <?php if ($_SESSION['department'] === 'Basic Education') {
                            ...
                            echo '<li class="nav-item"><a href="' . URLROOT . '/registrars/higher_subjects" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-book-open text-light fa-lg mr-3"></i>Subjects</a></li>';
                                ...
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            <li class="breadcrumb-item ml-lg-auto"> <a class="text-danger" href="<?php echo URLROOT; ?>/registrars/higher_subjects">Courses</a></li>
                                                    ...
                                                    <tr id="rows">
                                                        <td data-label="Subject" class="colSubject">
                                                            <select id="gradeLevel1" class="form-control subjectSelect">
                                                                ...
                                                                <?php foreach ($data['subjectCourseAssign'] as $seniorData) : ?>
                                                                    <option value="<?php echo $seniorData->code . '......' . $seniorData->description . '......' . $seniorData->units; ?>"><?php echo $seniorData->code . ' - ' . $seniorData->description; ?></option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                        </td>
                            ...
                            <div>
                                <div class="table-responsive mb-5">
                                    <table class="tablesgrade" id="recordsTable">
                                        ...
                                        <tbody>
                                            <?php if (!empty($data['higherSubject'])) : ?>

                                                <?php foreach ($data['higherSubject'] as $subjectList) : ?>
                                                    <tr class="">
                                                        ...
                                                        <td data-label="Year Level">
                                                            <?php echo $subjectList->year_level; ?>
                                                        </td>
...
<script>
    $(document).ready(function() {
        ...
        $('#addCol').click(function() {
            ...
            $.ajax({
                url: '<?php echo URLROOT ?>' + '/Actions/getHigherSubjectData',
                method: 'post',
                data: {
                    count: count,
                    programId: programId
        ...
        $('.saveData').click(function() {
            ...
            if (noSelectSubject === false || noSelectLevel === false || noSelectSem === false || noSelectCore === false) {
                ...
                $('.saveRec').click(function() {
                    $.ajax({
                        url: '<?php echo URLROOT ?>' + '/Actions/insertHigherSubjects',
                        method: 'post',
                        data: {
                            tableData: tableData,
                            programId: programId
        ...
        $('#recordsTable tbody').on('click', '.recRow', function() {
            ...
            if (yearLevel.trim() === '1') {
                newYear = 1;
            } else if (yearLevel.trim() === '2') {
                newYear = 2;
            } else if (yearLevel.trim() === '3') {
                newYear = 3;
            } else if (yearLevel.trim() === '4') {
                newYear = 4;
            }
            ...
            $('.updateRec').click(function() {
                if ($('#editLevel').val() === 'Choose...' || $('#editSem').val() === 'Choose...') {
                    alert('Please complete all fields')
                } else {
                    $.ajax({
                        url: '<?php echo URLROOT ?>' + '/Actions/updateHigherSubjectPattern',
                        method: 'post',
                        data: {
                            recId: recId,
        ...
        $('.btnDelete').click(function() {
            ...
            $('.deleteRec').click(function() {
                $.ajax({
                    url: '<?php echo URLROOT ?>' + '/Actions/deleteHigherSubjectPattern',
                    method: 'post',
                    data: {
                        recId: recId
                    },
