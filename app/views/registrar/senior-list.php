                                ...
                                <div class="col-lg-6">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb pl-0 pt-0 bg-white">
                                            ...
                                            <li class="breadcrumb-item active ml-lg-auto" aria-current="page">Student List</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                ...
                <div class="col-12 mx-auto">
                    <div class="card pl-0 pr-0 mt-1">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-8">
                                    <form class="form-inline" method="POST" action="<?php echo URLROOT; ?>/registrars/senior_records">
                            ...
                            <?php if (!empty($data['seniorStudentList'])) : ?>
                                <div id="output">
                                    <div class="table-responsive mb-5">
                                        <table class="tablesgrade">
                                            ...
                                            <tbody>
                                                <?php foreach ($data['seniorStudentList'] as $studentList) : ?>
                                                    <tr>
                                                        <td data-label="Full Name">
                                                            <a href="<?php echo URLROOT; ?>/registrars/senior137/<?php echo $studentList->infoId; ?>" class="text-body font-weight-bold"><?php echo $studentList->lname . ', ' . $studentList->fname . ' ' . $studentList->mname; ?></a>
                                                        </td>
                                                        <td data-label="Address">
                                                            <?php echo $studentList->add1; ?>

                                                        </td>
                                                        <td data-label="View Records">
                                                            <a class="btn btn-danger" href="<?php echo URLROOT; ?>/registrars/senior137/<?php echo $studentList->infoId; ?>" role="button"><i class="far fa-folder-open text-light fa-lg mr-1"></i> View</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                            ...
                            <?php endif; ?>
                            <?php if (empty($data['seniorStudentList'])) : ?>
                                <h5 class="ml-1 mt-3 mb-3"><?php echo 'No student available'; ?></h5>
                            <?php endif; ?>
